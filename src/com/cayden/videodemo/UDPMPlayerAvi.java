 ...
 * @version 1.0.0
 */
public class UDPMPlayerAvi extends Activity {

	private static final String TAG="UDPMPlayerTwo";
	 ...
	 */
	private static final int READY_BUFF = 10000 * 1024;
	/**
...
//				curPosition = 0;
		...
		mVideoView.setOnErrorListener(new OnErrorListener() {
			...
			public boolean onError(MediaPlayer mp, int i, int j) {
				Log.i(TAG, "onError i="+i+" j="+j);
				try{
					iserror = true;
					errorCnt++;
					mVideoView.pause();
					Log.i(TAG, "onError pause"+i+" j="+j);
					showProgressDialog();
				}catch(Exception e){
					e.printStackTrace();
				}
		...
		mHandler.post(new Runnable() {
			...
			public void run() {
				if (progressDialog == null) {
					progressDialog = ProgressDialog.show(UDPMPlayerAvi.this,
